...
class StarterSite extends TimberSite {
  ...
  //       ));
		register_nav_menus(array(
          'footer' => 'Footer Menu',
		  'footer_finnish' => 'Footer Menu Finnish',
		  'header_menu'=> 'Header Menu',
		  'header_menu_finnish' => 'Header Menu Finnish'
          )
        );
	...
	function add_to_context( $context ) {
		...
		$context['foot_menu'] = new TimberMenu('footer');
		$context['foot_menu_finnish'] = new TimberMenu('footer_finnish');

		$context['header_menu'] = new TimberMenu('header_menu');
		$context['header_menu_finnish'] = new TimberMenu('header_menu_finnish');
		...
		$context['address_finnish'] =get_field('address_finnish','option');
		$context['tos'] =get_field('terms_of_use','option');		
		$context['tos_finnish'] =get_field('terms_of_use_finnish','option');		
		$context['privacy'] =get_field('privacy','option');
		$context['privacy_finnish'] =get_field('privacy_finnish','option');		
